...
const AjudaPage: React.FC = () => {
  ...
  const faq = [
    ...
    { q: 'Preciso pagar para continuar ouvindo?', a: 'Não. A plataforma não opera com plano pago. Depois de ouvir o primeiro hino como visitante, basta fazer seu cadastro gratuito para continuar ouvindo.' },
  ];
