...
const TOPICS: Record<HinarioTopic, TopicConfig> = {
  hinario5: {
    ...
    title: 'Hinário 5 CCB | Letras dos Hinos da Congregação Cristã',
    description: 'Acesse o Hinário 5 CCB com letras dos hinos, navegação por número e links para ouvir hinos da Congregação Cristã no Brasil.',
  ...
  letras: {
    ...
    description: 'Veja letras dos hinos CCB com navegação por número, título e acesso ao Hinário da Congregação Cristã no Brasil.',
