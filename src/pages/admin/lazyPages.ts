...
export const AdminUserEdit = lazy(() => import('./AdminUserEdit'));
export const AdminUserForm = lazy(() => import('./AdminUserForm'));
...
export const AdminHymns = lazy(() => import('./AdminHymns'));
export const AdminHymnForm = lazy(() => import('./AdminHymnForm'));
export const AdminYoutubeImport = lazy(() => import('./AdminYoutubeImport'));
export const AdminSongs = lazy(() => import('./AdminSongs'));
export const AdminSongsPending = lazy(() => import('./songs/AdminSongsPending'));
export const AdminSongDetails = lazy(() => import('./songs/AdminSongDetails'));
export const AdminSongForm = lazy(() => import('./AdminSongForm'));
export const AdminAlbums = lazy(() => import('./AdminAlbums'));
export const AdminAlbumForm = lazy(() => import('./AdminAlbumForm'));
export const AdminCategories = lazy(() => import('./AdminCategories'));
export const AdminCategoryForm = lazy(() => import('./AdminCategoryForm'));
export const AdminGenres = lazy(() => import('./AdminGenres'));
export const AdminGenreForm = lazy(() => import('./AdminGenreForm'));
export const AdminTags = lazy(() => import('./AdminTags'));
export const AdminTagForm = lazy(() => import('./AdminTagForm'));
export const AdminPlaylistsEditorial = lazy(() => import('./AdminPlaylistsEditorial'));
export const AdminPlaylistForm = lazy(() => import('./AdminPlaylistForm'));

export const AdminBanners = lazy(() => import('./AdminBanners'));
export const AdminBannerForm = lazy(() => import('./AdminBannerForm'));
export const AdminFeatured = lazy(() => import('./AdminFeatured'));
export const AdminFeaturedForm = lazy(() => import('./AdminFeaturedForm'));
export const AdminCollections = lazy(() => import('./AdminCollections'));
export const AdminCollectionForm = lazy(() => import('./AdminCollectionForm'));
export const AdminCampaigns = lazy(() => import('./AdminCampaigns'));
export const AdminCampaignForm = lazy(() => import('./AdminCampaignForm'));
export const AdminPromotions = lazy(() => import('./AdminPromotions'));
export const AdminPromotionForm = lazy(() => import('./AdminPromotionForm'));
export const AdminCoupons = lazy(() => import('./AdminCoupons'));
export const AdminCouponForm = lazy(() => import('./AdminCouponForm'));

export const AdminAnalytics = lazy(() => import('./AdminAnalytics'));
export const AdminReports = lazy(() => import('./reports/AdminReports'));
export const AdminReportDetail = lazy(() => import('./reports/AdminReportDetail'));
export const AdminReportAnalytics = lazy(() => import('./reports/AdminReportAnalytics'));
export const AdminReportLogs = lazy(() => import('./reports/AdminReportLogs'));
...
export const AdminCopyrightClaims = lazy(() => import('./AdminCopyrightClaims'));
...
export const AdminBackupForm = lazy(() => import('./AdminBackupForm'));
export const AdminImport = lazy(() => import('./AdminImport'));
export const AdminImportForm = lazy(() => import('./AdminImportForm'));
export const AdminExport = lazy(() => import('./AdminExport'));
export const AdminExportForm = lazy(() => import('./AdminExportForm'));
export const AdminAPI = lazy(() => import('./api/AdminAPI'));
export const AdminAPIForm = lazy(() => import('./AdminAPIForm'));
export const AdminNotices = lazy(() => import('./AdminNotices'));
export const AdminNoticeForm = lazy(() => import('./AdminNoticeForm'));
export const AdminBibleNarrated = lazy(() => import('./AdminBibleNarrated'));
