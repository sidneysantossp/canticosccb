...
async function persistVersionContent(input: PersistCifraVersionInput): Promise<CifraVersion | null> {
  ...
  const versionPatch: UpdateCifraVersionInput = {
    ...
    defaultStudySectionOrder: input.versionPatch?.defaultStudySectionOrder ?? version.default_study_section_order,
    defaultStudySyncAudio: input.versionPatch?.defaultStudySyncAudio ?? version.default_study_sync_audio,
    defaultStudyLoopSection: input.versionPatch?.defaultStudyLoopSection ?? version.default_study_loop_section,
