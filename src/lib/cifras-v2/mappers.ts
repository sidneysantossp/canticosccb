...
export function mapCifraVersionRow(row: any): CifraVersion {
  return {
    ...
    default_study_section_order: asNullableNumber(row.default_study_section_order),
    default_study_sync_audio: asBoolean(row.default_study_sync_audio, false),
    default_study_loop_section: asBoolean(row.default_study_loop_section, false),
