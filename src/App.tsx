...
const protectContent = (content: React.ReactNode, directory: ContentProtectionDirectory) => (
  <ContentCopyProtection directory={directory}>{content}</ContentCopyProtection>
);
    ...
    <Suspense fallback={null}>
      ...
      <Routes>
        ...
        <Route path="/" element={<Layout />}>
          ...
          <Route path="cifras" element={protectContent(<CifrasLandingPage />, 'cifras')} />
          <Route path="cifras/:instrument" element={protectContent(<CifraInstrumentRoute />, 'cifras')} />
          <Route path="cifras-hinos-ccb" element={protectContent(<CifrasHubPage />, 'cifras')} />
          <Route path="cifras-violao-ccb" element={protectContent(<CifraInstrumentHubPage instrument="violao" />, 'cifras')} />
          <Route path="cifras-ukulele-ccb" element={protectContent(<CifraInstrumentHubPage instrument="ukulele" />, 'cifras')} />
          <Route path="cifras-teclado-ccb" element={protectContent(<CifraInstrumentHubPage instrument="teclado" />, 'cifras')} />
          <Route path="cifras/:instrument/:slug" element={protectContent(<CifraPage />, 'cifras')} />
          <Route path="cifra/:slug" element={protectContent(<CifraPage />, 'cifras')} />
          <Route path="profile/cifras/contribuir" element={<ProtectedRoute><CifraContributionPage /></ProtectedRoute>} />
          <Route path="hinario" element={protectContent(<HinarioListPage />, 'hinario')} />
          <Route path="hinos-ccb" element={<HinosHubPage />} />
          <Route path="hinos-1-a-120-ccb" element={protectContent(<HinarioRangePage rangeKey="1-120" />, 'hinario')} />
          <Route path="hinos-121-a-240-ccb" element={protectContent(<HinarioRangePage rangeKey="121-240" />, 'hinario')} />
          <Route path="hinos-241-a-360-ccb" element={protectContent(<HinarioRangePage rangeKey="241-360" />, 'hinario')} />
          <Route path="hinos-361-a-480-ccb" element={protectContent(<HinarioRangePage rangeKey="361-480" />, 'hinario')} />
          <Route path="hinario-5-ccb" element={protectContent(<HinarioTopicPage topic="hinario5" />, 'hinario')} />
          <Route path="hinario/:slug" element={protectContent(<HinarioViewPage />, 'hinario')} />
          <Route path="letras-hinos-ccb" element={protectContent(<HinarioTopicPage topic="letras" />, 'hinario')} />
          ...
          <Route path="biblia-ccb" element={protectContent(<BibleHubPage />, 'biblia')} />
          <Route path="biblia-ccb/busca" element={protectContent(<BibleExplorePage section="busca" />, 'biblia')} />
          <Route path="biblia-ccb/temas" element={protectContent(<BibleExplorePage section="temas" />, 'biblia')} />
          <Route path="biblia-ccb/personagens" element={protectContent(<BibleExplorePage section="personagens" />, 'biblia')} />
          <Route path="biblia-ccb/dicionario" element={protectContent(<BibleExplorePage section="dicionario" />, 'biblia')} />
          <Route path="biblia-ccb/:bookSlug/:chapterSlug" element={protectContent(<BibleChapterPage />, 'biblia')} />
          <Route path="biblia-ccb/:bookSlug" element={protectContent(<BibleBookPage />, 'biblia')} />
          <Route path="biblia-narrada" element={protectContent(<BibliaNarradaPage />, 'biblia')} />
          ...
          <Route path="admin/protecao-conteudo" element={<ProtectedRoute requireAdmin><AdminContentProtection /></ProtectedRoute>} />
