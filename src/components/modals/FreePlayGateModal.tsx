        ...
        <div className="bg-gradient-to-b from-purple-700 via-purple-800 to-purple-950 p-6 pb-8">
          ...
          <div className="flex flex-col items-center text-center pt-2">
            ...
            {googleAuthEnabled ? (
              ...
              <div className="w-full max-w-xs rounded-2xl border border-yellow-500/30 bg-yellow-500/10 px-4 py-3 mb-3">
                <p className="text-xs text-yellow-100">
                  O acesso com Google será reativado após concluir a configuração do novo projeto.
                </p>
              </div>
            )}
