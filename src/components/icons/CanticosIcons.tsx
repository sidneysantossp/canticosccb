import type { SVGProps, CSSProperties, HTMLAttributes } from 'react';
...
export interface CanticosRasterIconProps extends Omit<HTMLAttributes<HTMLSpanElement>, 'style'> { size?: number | string; active?: boolean; accentColor?: string; style?: CSSProperties }
...
export const AvulsosIcon = ({ size = 29, className, style, active, accentColor, ...props }: CanticosRasterIconProps) => (
  <span
    aria-hidden="true"
    className={className}
    {...props}
...
export const InstrumentalIcon = ({ size = 29, className, style, active, accentColor, ...props }: CanticosRasterIconProps) => (
  <span
    aria-hidden="true"
    className={className}
    {...props}
